...
class AttendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attend" do
    assert_difference('Attend.count') do
      post attends_url, params: { attend: { activity_id: @attend.activity_id, user_id: @attend.user_id } }
    end
  ...
  test "should update attend" do
    patch attend_url(@attend), params: { attend: { activity_id: @attend.activity_id, user_id: @attend.user_id } }
